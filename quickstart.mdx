...
<Note>
The Aegis CLI is currently in early access. If `npm install` reports the package isn't found, email [support@takumo.io](mailto:support@takumo.io) for preview access. The gateway install ([Helm on-prem](/deployment/onprem)) is generally available today.
</Note>
...
<Card title="Next: Installation" icon="arrow-right" href="/installation">
  All the ways to install Takumo
</Card>
