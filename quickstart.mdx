...
const config = {
  ...
  dbUrl: "postgres://admin:password123@prod.internal:5432/myapp",
  stripeKey: "sk_live_51ABC123xyz"
};
...
Found 3 secrets:
  ...
  Line 4   Database URL           postgres://admin:pass...
  Line 5   Stripe Secret Key      sk_live_51ABC123xyz
