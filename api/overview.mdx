...
```bash
npm install @takumo/aegis
```

The Aegis SDK is currently in early access — email [support@takumo.io](mailto:support@takumo.io) if the package isn't yet published.
