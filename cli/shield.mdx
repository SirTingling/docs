...
```
┌──────────────────────────────────────────────────────────┐
│ 1. DETECT     Find secrets in your code                  │
│ 2. TOKENIZE   Replace secrets with tokens                │
│ 3. SEND       Send tokenized code + prompt to Claude     │
│ 4. RECEIVE    Get Claude's response (still tokenized)    │
│ 5. REHYDRATE  Swap tokens back to real secrets           │
│ 6. OUTPUT     Print or save the final code               │
└──────────────────────────────────────────────────────────┘
```
