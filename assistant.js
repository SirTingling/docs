...
<div class="takumo-assistant-msg-tools${vote ? ' acted' : ''}">
  ...
  <button class="takumo-assistant-msg-tool${vote === 'up' ? ' active' : ''}" data-tool="up" title="Helpful" aria-label="Mark as helpful">
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M7 10v12"/><path d="M15 5.88 14 10h5.83a2 2 0 0 1 1.92 2.56l-2.33 8A2 2 0 0 1 17.5 22H7a2 2 0 0 1-2-2v-8a2 2 0 0 1 2-2h2.76a2 2 0 0 0 1.79-1.11L12 6h0a3.13 3.13 0 0 0 3-3.88Z"/></svg>
  </button>
  <button class="takumo-assistant-msg-tool${vote === 'down' ? ' active' : ''}" data-tool="down" title="Not helpful" aria-label="Mark as not helpful">
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M17 14V2"/><path d="M9 18.12 10 14H4.17a2 2 0 0 1-1.92-2.56l2.33-8A2 2 0 0 1 6.5 2H17a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2h-2.76a2 2 0 0 0-1.79 1.11L12 18h0a3.13 3.13 0 0 1-3 3.88Z"/></svg>
  </button>
</div>`
    }
