...
<CardGroup cols={2}>
  ...
  <Card title="Sentinel" icon="eye" href="/concepts/sentinel">
    **Inbound.** Validates AI-generated code before you use it. Dashboard scanning available, standalone API coming.
  </Card>
</CardGroup>
...
<Card title="Request Access" icon="arrow-right" href="mailto:jordant@takumo.com?subject=Takumo%20Access%20Request">
