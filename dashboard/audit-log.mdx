...
Custom plans unlock additional audit capabilities:
...
<Accordion title="Extended Retention">
  Custom-plan audit logs are retained for 365 days. For organizations with regulatory requirements that exceed this, contact us about custom retention policies.
</Accordion>
