...
// All detected
const stripe = {
  secret: "sk_live_51HG3J2eZvKYlo2C0...",
  publishable: "pk_live_51HG3J2eZvKYlo2C0...",
...
// All detected
const dbs = {
  pg: "postgres://admin:secret@db.internal:5432/app",
  mongo: "mongodb+srv://user:pass@cluster.mongodb.net/db",
  redis: "redis://:password@cache.internal:6379"
};
```
