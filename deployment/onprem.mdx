...
| Redis | 7+ |
| Container registry access | Outbound HTTPS to the Takumo image registry (contact [support@takumo.io](mailto:support@takumo.io) for image pull credentials if you're on a restricted network) |
